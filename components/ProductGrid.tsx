            ...
            <div className="px-6 pb-6">
              {!cartItem ? (
                <button
                  ...
                  className="w-full bg-yellow-500 text-black font-semibold py-3 rounded-full flex items-center justify-center gap-2 hover:bg-yellow-400 transition"
                >
                  <ShoppingCart size={18} />
                  Add to Cart
                </button>
              ) : (
                <div className="flex items-center justify-between bg-white rounded-full px-4 py-3">
                  <button
                    onClick={() =>
